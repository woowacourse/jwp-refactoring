...
import static kitchenpos.acceptance.step.TableStep.테이블_상태_Empty로_변경_요청;
import static kitchenpos.acceptance.step.TableStep.테이블_생성_요청;
import static kitchenpos.acceptance.step.TableStep.테이블_생성_요청하고_아이디_반환;
import static kitchenpos.acceptance.step.TableStep.테이블_조회_요청;
import static kitchenpos.acceptance.step.TableStep.테이블에_앉은_사람_수_변경_요청;
