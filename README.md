...
- [ ] 메뉴를 추가한다
    - [ ] [예외] 메뉴 속 상품들은 모두 DB에 등록되어야 한다
    - [ ] [예외] 메뉴 가격은 0 이상이어야 한다
- [ ] 메뉴 목록을 조회한다
...
- [ ] 주문을 추가한다
    - [ ] [예외] 주문한 메뉴들은 모두 DB에 등록되어야 한다
    - [ ] [예외] 주문 테이블은 DB에 등록되어야 한다
    - [ ] [예외] 주문 테이블은 손님이 존재해야 한다
- [ ] 주문 목록을 조회한다
- [ ] 특정 주문의 주문 상태를 변경한다
    - [ ] [예외] 주문 상태가 COMPLETION일 시 주문 상태를 변경할 수 없다
