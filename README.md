...
### step3 기록
- 리팩토링 진행 순서는 패키지 분리 -> 클래스 의존성 사이클 제거 -> 패키지 의존성 사이클 제거
...
- 양방향 연관관계를 제거하고(다중성이 적은 방향으로) ID 참조를 통해 도메인 경계 간의 격리성을 강화하니 서비스에 비즈니스 로직이 새어나오게 되었다.
  - 도메인 경계를 넘어선 협력이기 때문에 서비스에 드러나는게 어찌 보면 당연하기도 한 것 같다.
...
![image](https://github.com/woosung1223/jwp-refactoring/assets/78679830/dfcccf78-e9ef-41cf-beed-41545d876ce6)

- 패키지 의존성 리팩토링 후

![image](https://github.com/woosung1223/jwp-refactoring/assets/78679830/5555606d-e912-4757-a941-3cd8a6692d42)
