...
- [ ] 메뉴의 가격이 올바르지 않으면 등록할 수 없다.
    ...
    - [ ] 메뉴의 가격은 메뉴에 속한 상품 금액의 합보다 같거나 작아야 한다.
...
- [ ] 단체 지정 시 테이블은 중복될 수 없다.
- [ ] 단체 지정을 해지할 수 있다.
- [ ] 단체 지정된 주문 테이블의 주문 상태가 특정한 경우 단체 지정을 해지할 수 없다.
    - [ ] 주문 상태가 조리인 경우 단체 지정을 해지할 수 없다.
    - [ ] 주문 상태가 식사인 경우 단체 지정을 해지할 수 없다.
