...
- [x] 주문 항목 도메인 리팩토링 
- [x] 테이블 도메인 리팩토링 
- [x] 주문-테이블 연결 도메인 리팩토링

### Dao를 Repository로 리팩토링하고, 테스트를 작성한다.
- [x] 메뉴 Repository 리팩토링 
- [x] 메뉴 그룹 Repository 리팩토링 
- [x] 상품 Repository 리팩토링 
- [x] 메뉴-상품 연결 Repository 리팩토링 
- [x] 주문 Repository 리팩토링
  - 주문 상태에 대한 리팩토링
- [x] 주문 항목 Repository 리팩토링 
- [x] 테이블 Repository 리팩토링 
- [x] 주문-테이블 연결 Repository 리팩토링
  
### 서비스를 리팩토링하고, 테스트 코드 역시 리팩토링한다.
- [x] 메뉴 서비스에 대한 테스트 코드 리팩토링
- [x] 메뉴 그룹 서비스에 대한 테스트 코드 리팩토링
- [x] 주문 서비스에 대한 테스트 코드 리팩토링
- [x] 상품 서비스에 대한 테스트 코드 리팩토링
- [x] 테이블 서비스에 대한 테스트 코드 리팩토링
- [x] 테이블 그룹 서비스에 대한 테스트 코드 리팩토링

### 컨트롤러를 리팩토링하고, 테스트 코드를 작성한다.
- [x] 메뉴 그룹 컨트롤러에 대한 테스트 코드 작성
- [x] 메뉴 컨트롤러에 대한 테스트 코드 작성
- [x] 주문 컨트롤러에 대한 테스트 코드 작성
- [x] 상품 컨트롤러에 대한 테스트 코드 작성
- [x] 테이블 컨트롤러에 대한 테스트 코드 작성
- [x] 테이블 그룹 컨트롤러에 대한 테스트 코드 작성
