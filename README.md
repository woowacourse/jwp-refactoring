...
-[ ] 올바르지 않은 메뉴 가격에 대한 예외 처리
    * 메뉴의 가격은 null이 될 수 없다.
    * 메뉴의 가격은 0 원 이상이어야 한다.
    * 메뉴에 속한 상품 금액의 합은 메뉴의 가격 보다 크거나 같아야 한다.
-[ ] 메뉴와 메뉴 그룹의 연관관계 매핑
-[ ] 올바르지 않은 메뉴와 메뉴 그룹의 연관관계 매핑에 대한 예외 처리
    * 메뉴와 연관관계가 있는 메뉴 그룹의 아이디가 존재하면 안된다. 
-[ ] 메뉴 목록 조회 기능 구현
...
-[ ] 빈 테이블 단체 지정 혹은 해지 기능 구현
-[ ] 올바르지 않은 단체 지정에 대한 예외 처리
