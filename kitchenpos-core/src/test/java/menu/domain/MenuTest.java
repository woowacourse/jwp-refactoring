...
class MenuTest {
    ...
    class MenuCreateTest {
        ...
        void menuCreateTest() {
            ...
            final List<kitchenpos.menu.domain.MenuProduct> menuProducts = List.of(new kitchenpos.menu.domain.MenuProduct(product, 4));
        ...
        void menuCreateFailWhenPriceLessThenZero() {
            ...
            final long menuGroupId = 1L;
            final List<kitchenpos.menu.domain.MenuProduct> menuProducts = Collections.emptyList();

            // when & then
            Assertions.assertThatThrownBy(() -> new Menu(menuName, price, menuGroupId, menuProducts))
