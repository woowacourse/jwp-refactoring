...
public class TableRestController {
    ...
    public ResponseEntity<OrderTable> create(@RequestBody final CreateOrderTableRequest request) {
        final OrderTable created = tableService.create(request.toCreateOrderTableDto());
    ...
    public ResponseEntity<OrderTable> changeEmpty(
        ...
        return ResponseEntity.ok()
                             .body(tableService.changeEmpty(orderTableId, request.toChangeOrderTableEmptyDto()))
                ;
    }
    ...
    public ResponseEntity<OrderTable> changeNumberOfGuests(
        ...
        return ResponseEntity.ok()
                             .body(tableService.changeNumberOfGuests(orderTableId, request.toChangeNumberOfGuestsDto()))
                ;
    }
}
