...
class OrderTableTest {
    ...
    class 주문_테이블이_비어있는지_여부를_변경할_때 {
        ...
        void 단체_지정된_주문_테이블이라면_예외를_던진다() {
            ...
            // expect
            Assertions.assertThatThrownBy(() -> groupedOrderTable.changeIsEmpty(isEmpty))
    ...
    class 주문_테이블의_손님_수를_변경할_때 {
        ...
        void 손님_수가_0_미만이면_예외를_던진다() {
            ...
            // expect
            Assertions.assertThatThrownBy(() -> orderTable.changeNumberOfGuests(invalidNumberOfGuests))
                    .isInstanceOf(IllegalArgumentException.class)
    ...
    class 주문_테이블이_주문을_받을_수_있는지_검증할_때 {
        ...
        void 빈_주문_테이블이면_예외를_던진다() {
            ...
            // expect
            Assertions.assertThatThrownBy(emptyOrderTable::validateTableCanTakeOrder)
                    .isInstanceOf(IllegalArgumentException.class)
        ...
        void 채워진_주문_테이블은_예외를_던지지_않는다() {
            ...
            // expect
            Assertions.assertThatNoException().isThrownBy(filledOrderTable::validateTableCanTakeOrder);
        }
    }
}
