...
class OrderTableTest {
    ...
    void validateNumberOfGuest() {
        Assertions.assertThatThrownBy(() -> new OrderTable(-1, true))
    ...
    class ChangeNumberOfGuests {
        ...
        @DisplayName("정상적으로 변경하는 경우")
        void success() {
            final OrderTable table = TableFixture.비어있지_않는_주문_테이블();
        ...
        void throwExceptionTableIsEmpty() {
            final OrderTable emptyTable = TableFixture.비어있는_주문_테이블();

            Assertions.assertThatThrownBy(() -> emptyTable.changeNumberOfGuests(10))
                .isInstanceOf(OrderTableException.class)
        ...
        void throwExceptionNumberOfGuestIsLowerThanZero() {
            ...
            Assertions.assertThatThrownBy(() -> emptyTable.changeNumberOfGuests(-1))
                .isInstanceOf(OrderTableException.class)
                .hasMessage(NUMBER_OF_GUEST_LOWER_THAN_ZERO.getMessage());
        }
    }
