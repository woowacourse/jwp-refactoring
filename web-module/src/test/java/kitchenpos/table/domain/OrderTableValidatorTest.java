...
class OrderTableValidatorTest extends ApplicationTestConfig {
    ...
    void success_validateChangeEmpty() {
        ...
        // expect
        assertThatCode(() -> orderTableValidator.validateChangeEmpty(savedOrderTable.getId()))
    ...
    void throwException_validateChangeEmpty() {
        ...
        // expect
        assertThatThrownBy(() -> orderTableValidator.validateChangeEmpty(savedOrderTable.getId()))
