...
class TableGroupServiceTest extends ServiceTest {
    ...
    class 단체_지정_등록 {
        ...
        void 단체_지정을_등록한다() {
            ...
            // then
            Assertions.assertThat(tableGroupId).isNotNull();
        }
    ...
    class 단체_지정_헤제 {
        ...
        void 단체_지정을_헤제한다() {
            ...
            Assertions.assertThat(orderTables.get(0).getTableGroupId()).isNull();
            Assertions.assertThat(orderTables.get(1).getTableGroupId()).isNull();
        }
