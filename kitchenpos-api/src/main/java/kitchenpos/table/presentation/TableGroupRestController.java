...
public class TableGroupRestController {
    ...
    public ResponseEntity<TableGroupResponse> create(@RequestBody final TableGroupRequest tableGroupRequest) {
        TableGroupResponse tableGroupResponse = tableGroupService.create(tableGroupRequest.toCommand());
        final URI uri = URI.create("/api/table-groups/" + tableGroupResponse.id());
