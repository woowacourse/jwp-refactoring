...
class OrderTest {
    ...
    class 주문을_생성할_때 {
        ...
        void 정상적으로_생성한다() {
            ...
            // expect
            Assertions.assertThatNoException().isThrownBy(() -> Order.of(orderTableId, orderLineItems, menuCount));
        }
        ...
        void 주문_항목_목록이_없으면_예외를_던진다() {
            ...
            // expect
            Assertions.assertThatThrownBy(() -> Order.of(orderTableId, invalidOrderLineItems, menuCount))
        ...
        void 주문_항목_목록_크기와_메뉴_수가_다르면_예외를_던진다() {
            ...
            // expect
            Assertions.assertThatThrownBy(() -> Order.of(orderTableId, orderLineItems, invalidMenuCount))
                    .isInstanceOf(IllegalArgumentException.class)
    ...
    class 주문_상태를_변경할_때 {
        ...
        void 계산_완료된_주문이라면_예외를_던진다() {
            ...
            // expect
            Assertions.assertThatThrownBy(() -> order.changeOrderStatus(COOKING.name()))
                    .isInstanceOf(IllegalArgumentException.class)
