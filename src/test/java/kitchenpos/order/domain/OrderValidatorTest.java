...
class OrderValidatorTest {
    ...
    void validate() {
        ...
        final Order order = new Order(orderTable.getId(), OrderStatus.COOKING, new OrderLineItems(List.of(주문_항목)));
    ...
    void validate_invalidOrderTable() {
        ...
        final Order invalidOrder = new Order(invalidOrderTableId, OrderStatus.COOKING, new OrderLineItems(List.of(주문_항목)));
    ...
    void validate_emptyTable() {
        ...
        final Order invalidOrder = new Order(비어있는_테이블.getId(), OrderStatus.COOKING, new OrderLineItems(List.of(주문_항목)));
