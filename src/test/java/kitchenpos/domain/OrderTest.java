...
class OrderTest {
    ...
    void 중복_OrderLineItem_추기_시_예외() {
        ...
        OrderLineItem orderLineItem1 = new OrderLineItem(1L, 1L, order, 10L);
        order.addOrderLineItems(List.of(orderLineItem1));

        OrderLineItem orderLineItem2 = new OrderLineItem(2L, 1L, order, 5L);
    ...
    void 다른_주문의_주문_상품을_넣으면_예외() {
        ...
        OrderLineItem orderLineItem = new OrderLineItem(1L, 1L, otherOrder, 10L);
