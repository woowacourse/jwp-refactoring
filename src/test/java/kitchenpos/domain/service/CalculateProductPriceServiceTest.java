...
class CalculateProductPriceServiceTest {
    ...
    void calculateMenuProductPriceSum() {
        ...
        final MenuProduct menuProduct1 = new MenuProduct(1L, 1L, 1);
        final MenuProduct menuProduct2 = new MenuProduct(1L, 2L, 1);
        final MenuProduct menuProduct3 = new MenuProduct(1L, 3L, 2);
