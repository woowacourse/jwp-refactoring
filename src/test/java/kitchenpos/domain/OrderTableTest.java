...
class OrderTableTest {
    ...
    void 테이블_그룹이_존재하는지_확인한다() {
        ...
        assertThatThrownBy(() -> 주문_테이블.validateTableGroupIsNull())
    ...
    void 테이블_상태를_비어있지_않은_테이블로_변경한다() {
        OrderTable 주문_테이블 = 새로운_주문_테이블(new TableGroup(), 0, true);
    ...
    void 방문한_손님_수를_변경할_때_방문한_손님_수가_0명_이상이어야_한다() {
        ...
        assertThatThrownBy(() -> 주문_테이블.changeNumberOfGuests(-1))
                .isInstanceOf(OrderTableException.class)
    ...
    void 방문한_손님_수를_변경할_때_테이블이_비어있지_않아야_한다() {
        ...
        assertThatThrownBy(() -> 주문_테이블.changeNumberOfGuests(3))
                .isInstanceOf(OrderTableException.class)
