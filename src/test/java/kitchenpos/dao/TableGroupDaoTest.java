...
class TableGroupDaoTest {
    ...
    void ID로_단체_지정을_조회한다() {
        ...
        TableGroup ID로_조회한_단체_지정 = tableGroupDao.findById(단체_지정.getId())
    ...
    void 존재하지_않는_ID로_단체_지정을_조회하면_Optional_empty를_반환한다() {
        Optional<TableGroup> 존재하지_않는_ID로_조회한_단체_지정 = tableGroupDao.findById(Long.MIN_VALUE);
    ...
    void 모든_단체_지정을_조회한다() {
        ...
        List<TableGroup> 모든_단체_지정 = tableGroupDao.findAll();
