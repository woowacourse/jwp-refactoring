...
class JdbcTemplateMenuProductDaoTest extends DaoTest {
    ...
    void findByIdFailByNotExistTest() {
        Optional<MenuProduct> menuProduct = jdbcTemplateMenuProductDao.findById(-1L);
    ...
    @Test
    void findByIdTest() {
        MenuProduct menuProduct = jdbcTemplateMenuProductDao.findById(MENU_PRODUCT_SEQ_1).get();
