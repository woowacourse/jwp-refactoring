...
class MenuGroupRestControllerTest {
    ...
    void create() throws Exception {
        MenuGroup menuGroup = TestObjectFactory.createMenuGroup("추천메뉴");
        menuGroup.setId(1L);
    ...
    void list() throws Exception {
        ...
        menus.add(TestObjectFactory.createMenuGroup("name1"));
        menus.add(TestObjectFactory.createMenuGroup("name2"));
