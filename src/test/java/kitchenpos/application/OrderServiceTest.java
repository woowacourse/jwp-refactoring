...
class OrderServiceTest {
    ...
    @Test
    void 주문을_생성_한다() {
        Order order = new Order(null, 1L, "COOKING", null, of(orderLineItem));
    ...
    void 완료_상태에서_주문_상태를_변경할_수_없다() {
        Order order = new Order(null, 1L, null, null, of(orderLineItem));
        Order saved = orderService.create(order);
    ...
    @Test
    void 주문_전체_조회를_한다() {
        orderService.create(new Order(null, 1L, "COOKING", null, of(orderLineItem)));
        orderService.create(new Order(null, 1L, "COOKING", null, of(orderLineItem)));
    ...
    class 주문을_생성_할_때 {
        ...
        void 빈_테이블에서_주문할_수_없다() {
            ...
            assertThatThrownBy(() -> orderService.create(new Order(null, emptyTableId, "COOKING", null, of(orderLineItem))))
                    .isInstanceOf(IllegalArgumentException.class);
        }
        ...
        void 없는_메뉴를_주문할_수_없다() {
            ...
            assertThatThrownBy(() -> orderService.create(new Order(null, 1L, "COOKING", null, of(new OrderLineItem(null, 1L, notExistMenuId, 1L)))))
                    .isInstanceOf(IllegalArgumentException.class);
        }
