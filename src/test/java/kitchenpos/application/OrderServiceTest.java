...
class OrderServiceTest extends ServiceTest {
    ...
    private OrderRequest 요리중_주문;

    @BeforeEach
    void setUp() {
        주문_테이블 = tableService.create(new OrderTableRequest( 3, false));
        요리중_주문 = new OrderRequest(주문_테이블.getId(), OrderStatus.COOKING.name(), LocalDateTime.now());
    }
//
//    @Test
//    void 주문을_생성할_수_있다() {
...
//        요리중_주문.addOrderLineItem(new OrderLineItemRequest(요리중_주문., ramen.getId(), 1));
