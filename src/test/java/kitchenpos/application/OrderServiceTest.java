...
class OrderServiceTest extends ServiceTest {
    ...
    void createNoExistMenu() {
        final Menu notExistMenu = new Menu(-1L, "없는메뉴", Price.valueOf(BigDecimal.valueOf(999_999L)), null);
    ...
    void createNoExistTable() {
        ...
        assertThatThrownBy(() -> 주문_요청한다(TableDto.of(notExistTable), 파스타한상.getId()))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void create() {
        ...
        final List<OrderLineItemDto> savedOrderLineItems = order.getOrderLineItems();
    ...
    void changeOrderStatusComplete() {
        ...
        final OrderDto completedOrder = 주문을_완료_상태로_만든다(order);
