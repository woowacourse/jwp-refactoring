...
public class MenuServiceFixture {
    ...
    void setUp() {
        ...
        메뉴_상품1 = new MenuProduct(상품1, 2);
        메뉴_상품1.updateSeq(1L);
        메뉴_상품2 = new MenuProduct(상품2, 2);
        메뉴_상품2.updateSeq(2L);
        MenuProduct 메뉴_상품3 = new MenuProduct(상품2, 1);
        메뉴_상품3.updateSeq(3L);
        ...
        저장된_메뉴.updateId(1L);
        메뉴_상품1.updateMenuId(저장된_메뉴.getMenuGroup().getId());
        메뉴_상품2.updateMenuId(저장된_메뉴.getMenuGroup().getId());
        저장된_메뉴1 = 저장된_메뉴;
        저장된_메뉴2 = new Menu("메뉴_이름2", BigDecimal.valueOf(5000), 2L, List.of(메뉴_상품1, 메뉴_상품3));
        저장된_메뉴2.updateId(2L);

        MenuProduct 존재하지_않는_상품을_가진_메뉴_상품 = new MenuProduct(null, 2);
