...
class MenuServiceTest {
    ...
    void createTest() {
        ...
        given(productRepository.findById(anyLong())).willReturn(Optional.of(createProductWithId(1L)));
        given(menuRepository.save(any(Menu.class))).willReturn(createMenuWithId(1L));
        given(menuProductRepository.save(any(MenuProduct.class))).willReturn(createMenuProductWithProductId(1L));
    ...
    void createTest6() {
        given(menuGroupRepository.existsById(anyLong())).willReturn(true);
        given(productRepository.findById(anyLong())).willReturn(Optional.of(createProductWithPrice(BigDecimal.valueOf(5000))));
    ...
    void listTest() {
        ...
        given(menuRepository.findAll()).willReturn(createMenus());
        given(menuProductRepository.findAllByMenuId(anyLong())).willReturn(
