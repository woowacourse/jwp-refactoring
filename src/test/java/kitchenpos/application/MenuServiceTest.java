...
class MenuServiceTest extends ServiceTest {
    ...
    void create() {
        ...
        assertAll(
                () -> assertThat(menu)
                        ...
                        .isEqualTo(new Menu(1L, name, price, menuGroup, menu.getMenuProducts())),
    ...
    void list() {
        ...
        assertAll(
                ...
                () -> assertThat(actual).extracting("menuGroup").extracting("id")
                        .containsExactly(menuGroupId, menuGroupId),
