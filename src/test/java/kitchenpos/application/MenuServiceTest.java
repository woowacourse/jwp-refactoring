...
class MenuServiceTest {
    ...
    void list() {
        final List<Menu> expected = List.of(
                saveMenu("중식 세트", 23000, 1, List.of(
                        saveMenuProduct(1, 1, 1), saveMenuProduct(1, 3, 4))),
                saveMenu("일식 세트", 20000, 2, List.of(
                        saveMenuProduct(2, 1, 1), saveMenuProduct(2, 3, 4))));
    ...
    private Menu saveMenu(final String name, final int price, final long menuGroupId,
        ...
        final var menu = menuDao.save(new Menu(name, price, menuGroupId, savedMenuProducts));
