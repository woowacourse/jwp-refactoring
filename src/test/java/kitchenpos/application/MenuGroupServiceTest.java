...
class MenuGroupServiceTest {
    ...
    @Test
    void 메뉴_그룹을_등록한다() {
        MenuGroup menuGroup = Fixture.menuGroup("메뉴 그룹");
    ...
    @Test
    void 메뉴_그룹들을_조회한다() {
        MenuGroup group1 = menuGroupService.create(Fixture.menuGroup("메뉴 그룹1"));
        MenuGroup group2 = menuGroupService.create(Fixture.menuGroup("메뉴 그룹2"));
