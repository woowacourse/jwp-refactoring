...
class TableGroupServiceTest extends IntegrationTest {
    ...
    @Test
    void 테이블을_단체로_하나의_테이블로_묶을_수_있다() {
        // given
        ...
        // when
        TableGroup extract = tableGroupService.create(new TableGroup(LocalDateTime.now(), List.of(orderTable1, orderTable2)));
    ...
    @Test
    void 테이블을_단체로_하나의_테이블로_묶을때_빈_테이블이_아닐경우_예외가_발생한다() {
        // given
        OrderTable orderTable1 = tableService.create(new OrderTable(null, 2, true));
    ...
    @Test
    void 테이블을_단체로_하나의_테이블로_묶을때_2개_미만의_테이블일_경우_예외가_발생한다() {
        // given
        OrderTable orderTable1 = tableService.create(new OrderTable(null, 2, true));
    ...
    @Test
    void 입력한_주문_테이블이_이미_단체로_지정된_경우_예외가_발생한다() {
        // given
        OrderTable orderTable1 = tableService.create(new OrderTable(null, 2, true));
        OrderTable orderTable2 = tableService.create(new OrderTable(null, 3, true));
    ...
    @Test
    void 단체로_지정된_그룹을_해제할때_주문의_상태가_종료가_아닌경우_예외가_발생한다() {
        // given
