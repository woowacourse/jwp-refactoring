...
class TableGroupServiceTest extends ServiceTest {
    ...
    class create_메서드는 {
        ...
        class 정상적인_요청일_경우 {
            ...
            private final OrderTable orderTable1 = orderTableRepository.save(new OrderTable(null, null, 2, true));
        ...
        class 빈_주문_테이블_목록의_요청일_경우 {
            ...
            private final TableGroupCreateRequest tableGroupCreateRequest = new TableGroupCreateRequest(List.of());
        ...
        class 두개_미만의_주문_테이블_목록의_요청일_경우 {
            ...
            private final OrderTable orderTable = orderTableRepository.save(new OrderTable(null, null, 2, true));
            private final TableGroupCreateRequest tableGroupCreateRequest = new TableGroupCreateRequest(
                    List.of(new OrderTableRequest(orderTable.getId())));
        ...
        class 주문_테이블이_중복되는_경우 {
            ...
            private final OrderTable orderTable = orderTableRepository.save(new OrderTable(null, null, 2, true));
            private final TableGroupCreateRequest tableGroupCreateRequest = new TableGroupCreateRequest(
                    List.of(new OrderTableRequest(orderTable.getId()), new OrderTableRequest(orderTable.getId())));
        ...
        class 주문_테이블이_존재하지_않는_경우 {
            ...
            private final OrderTable orderTable1 = orderTableRepository.save(new OrderTable(null, null, 2, true));
            private final OrderTable orderTable2 = new OrderTable(null, null, 2, true);
            private final TableGroupCreateRequest tableGroupCreateRequest = new TableGroupCreateRequest(
                    List.of(new OrderTableRequest(orderTable1.getId()), new OrderTableRequest(orderTable2.getId())));
        ...
        class 주문_테이블이_활성화_되어있을_경우 {
            ...
            private final OrderTable orderTable1 = orderTableRepository.save(new OrderTable(null, null, 2, false));
            private final OrderTable orderTable2 = orderTableRepository.save(new OrderTable(null, null, 2, true));
            private final TableGroupCreateRequest tableGroupCreateRequest = new TableGroupCreateRequest(
                    List.of(new OrderTableRequest(orderTable1.getId()), new OrderTableRequest(orderTable2.getId())));
        ...
        class 주문_테이블이_이미_단체_지정이_되어있을_경우 {
            ...
            private final TableGroup savedTableGroup = tableGroupRepository.save(
    ...
    class ungroup_메서드는 {
        ...
        class 정상적인_요청일_경우 {
            ...
            private final OrderTable orderTable1 = orderTableRepository.save(new OrderTable(null, null, 2, true));
            private final OrderTable orderTable2 = orderTableRepository.save(new OrderTable(null, null, 2, true));
            private final TableGroupResponse tableGroupResponse = tableGroupService.create(
