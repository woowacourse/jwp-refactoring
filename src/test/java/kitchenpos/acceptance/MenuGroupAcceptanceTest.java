...
import static kitchenpos.KitchenPosFixtures.네_마리_메뉴;
...
public class MenuGroupAcceptanceTest extends AcceptanceTest {
    ...
    void 신규_메뉴그룹을_생성할_수_있다() {
        // given & when
        final var 메뉴그룹_생성응답 = 생성요청(메뉴그룹_URL, 세_마리_메뉴);
        final var 생성된_메뉴그룹 = 메뉴그룹_생성응답.body().as(MenuGroup.class);

        // then
        assertAll(
                응답일치(메뉴그룹_생성응답, HttpStatus.CREATED),
                단일_데이터_검증(생성된_메뉴그룹.getId(), 1L),
                단일_데이터_검증(생성된_메뉴그룹.getName(), 세_마리_메뉴.getName())
        );
    }
    ...
    void 전체_메뉴그룹을_조회할_수_있다() {
        // given
        생성요청(메뉴그룹_URL, 세_마리_메뉴);
        생성요청(메뉴그룹_URL, 네_마리_메뉴);
        ...
        assertAll(
                ...
                리스트_데이터_검증(메뉴그룹_응답_데이터, "name", 세_마리_메뉴.getName(), 네_마리_메뉴.getName())
        );
    }
}
