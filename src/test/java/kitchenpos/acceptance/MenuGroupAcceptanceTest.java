...
import static kitchenpos.DomainFixtures.면_메뉴_그룹_요청;
...
public class MenuGroupAcceptanceTest extends AcceptanceTest {
    ...
    void 메뉴_그룹을_추가한다() {
        MenuGroup menuGroup = testRestTemplate.postForObject("http://localhost:" + port + "/api/menu-groups",
                new MenuGroupRequest("면"), MenuGroup.class);
    ...
    void 메뉴_그룹을_조회한다() {
        testRestTemplate.postForObject("http://localhost:" + port + "/api/menu-groups",
                면_메뉴_그룹_요청(), MenuGroup.class);
        testRestTemplate.postForObject("http://localhost:" + port + "/api/menu-groups",
                new MenuGroupRequest("육류"), MenuGroup.class);
