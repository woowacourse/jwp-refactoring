...
class OrderIntegrationTest extends IntegrationTest {
    ...
    void 주문_전체_조회_시_주문_항목을_같이_조회할_수_있다() {
        Product product = productDao.save(new Product(null, "상품", BigDecimal.valueOf(1000)));
        ...
        List<OrderLineItem> orderLineItems = List.of(
                new OrderLineItem(null, menu.getId(), 1)
        );
    ...
    class 주문을_저장할_때 {
        ...
        void 주문_항목이_없으면_저장할_수_없다() {
            ...
            assertThatThrownBy(() -> orderService.create(new Order(null, orderTable, orderLineItems)))
        ...
        void 빈_주문_테이블에서_주문할_수_없다() {
            ...
            List<OrderLineItem> orderLineItems = List.of(
                    new OrderLineItem(null, menu.getId(), 1),
                    new OrderLineItem(null, menu2.getId(), 1)
            );
