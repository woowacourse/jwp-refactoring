...
public class MenuFixture {
    ...
    public static Menu MENU_1 =
            Menu.of("후라이드치킨", new BigDecimal("16000.00"), MENU_GROUP2,
                    new MenuProducts(List.of(new MenuProduct(null, null, PRODUCT_1, 1))));
    public static Menu MENU_2 = Menu.of("양념치킨", new BigDecimal("16000.00"), MENU_GROUP2,
            new MenuProducts(List.of(new MenuProduct(null, null, PRODUCT_2, 1))));
    public static Menu MENU_3 = Menu.of("반반치킨", new BigDecimal("16000.00"), MENU_GROUP2,
            new MenuProducts(List.of(new MenuProduct(null, null, PRODUCT_3, 1))));
    public static Menu MENU_4 = Menu.of("통구이", new BigDecimal("16000.00"), MENU_GROUP2,
            new MenuProducts(List.of(new MenuProduct(null, null, PRODUCT_4, 1))));
    public static Menu MENU_5 = Menu.of("간장치킨", new BigDecimal("17000.00"), MENU_GROUP2,
            new MenuProducts(List.of(new MenuProduct(null, null, PRODUCT_5, 1))));
    public static Menu MENU_6 = Menu.of("순살치킨", new BigDecimal("17000.00"), MENU_GROUP2,
    ...
    public static Menu MENU_1(Product product) {
        ...
        Menu 후라이드치킨 = Menu.of("후라이드치킨", new BigDecimal("16000.00"), MENU_GROUP2, menuProducts);
