...
public class MenuFixture {
    ...
    public static final Menu 후라이드치킨_BEFORE_SAVE;
    ...
    static {
        ...
        후라이드치킨_BEFORE_SAVE = newInstance(null, "후라이드치킨", new BigDecimal(16000), MenuGroupFixture.한마리메뉴.getId(), Collections.singletonList(MenuProductFixture.후라이드치킨_후라이드치킨_NO_KEY));
