...
import kitchenpos.application.command.OrderLineItemRequest;
...
public class RequestFixture {
    ...
    public static final CreateMenuCommand MENU_REQUEST = new CreateMenuCommand("후라이드+후라이드",
            BigDecimal.valueOf(19_000L), 1L, singletonList(new MenuProduct(1L, 2L)));
    public static final CreateMenuCommand MENU_REQUEST2 = new CreateMenuCommand("후라이드+후라이드",
            BigDecimal.valueOf(19_000L), 1L, singletonList(new MenuProduct(1L, 2L)));
