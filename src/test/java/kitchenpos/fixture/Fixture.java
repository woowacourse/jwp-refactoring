...
public class Fixture {
    ...
    public static final Menu MENU_후라이드치킨 = new Menu(1L, "후라이드치킨", new MenuPrice(BigDecimal.valueOf(16000)), 1L,
            List.of(new MenuProduct(PRODUCT_후라이드, 1L)));
    public static final Menu MENU_양념치킨 = new Menu(2L, "양념치킨", new MenuPrice(BigDecimal.valueOf(17000)), 1L,
            List.of(new MenuProduct(PRODUCT_양념치킨, 1L)));
