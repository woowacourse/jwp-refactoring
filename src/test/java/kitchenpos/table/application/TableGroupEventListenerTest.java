...
class TableGroupEventListenerTest extends ServiceIntegrationTest {
    ...
    void groupOrderTables() {
        ...
        final Long savedOrderTableId1 = tableService.create(비어있는_주문_테이블_DTO()).getId();
        final Long savedOrderTableId2 = tableService.create(비어있는_주문_테이블_DTO()).getId();
