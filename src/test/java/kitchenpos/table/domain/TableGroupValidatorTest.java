...
class TableGroupValidatorTest extends ApplicationTestConfig {
    ...
    @BeforeEach
    void setUp() {
        tableGroupValidator = new TableGroupValidator(orderRepository);
    }
    ...
    void success_validateUngroup() {
        ...
        // expect
        assertThatCode(() -> tableGroupValidator.validateUngroup(savedTableGroup))
    ...
    void throwException_validateUngroup() {
        ...
        // expect
        assertThatThrownBy(() -> tableGroupValidator.validateUngroup(savedTableGroup))
