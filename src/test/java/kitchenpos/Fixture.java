...
public class Fixture {
    ...
    public static final OrderTable ORDER_TABLE = new OrderTable(1L,1L, 0, false);

    private static final OrderTable ORDER_TABLE1 = new OrderTable(1L,1L, 0, false);
    private static final OrderTable ORDER_TABLE2 = new OrderTable(2L, 1L,1, false);
    public static final TableGroup TABLE_GROUP = new TableGroup(1L, LocalDateTime.now(),
            List.of(ORDER_TABLE1, ORDER_TABLE2));
}
