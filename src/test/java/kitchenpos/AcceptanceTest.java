...
public class AcceptanceTest {
    ...
    private Long 테이블_그룹_생성(Long 테이블_아이디1, Long 테이블_아이디2) throws Exception {
        ...
        MvcResult 요청_결과 = mockMvc.perform(post("/api/table-groups")
    ...
    private Long 주문(Long 메뉴_아이디, Long 테이블_아이디) throws Exception {
        ...
        MvcResult 요청_결과 = mockMvc.perform(post("/api/orders")
                        .content(주문_요청)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    private Long 상품_등록() throws Exception {
        ...
        MvcResult 요청_결과 = mockMvc.perform(post("/api/products")
                        .content(상품_등록_요청)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    private Long 메뉴_그룹_등록() throws Exception {
        ...
        MvcResult 요청_결과 = mockMvc.perform(post("/api/menu-groups")
                        .content(메뉴_그룹_등록_요청)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    private Long 메뉴_등록(Long 상품_아이디, Long 메뉴_그룹_아이디) throws Exception {
        ...
        MvcResult 요청_결과 = mockMvc.perform(post("/api/menus")
                        .content(메뉴_등록_요청)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    private Long 테이블_생성() throws Exception {
        ...
        MvcResult 요청_결과 = mockMvc.perform(post("/api/tables")
                        .content(테이블_생성_요청)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    private void 빈_테이블을_주문_테이블로_변경(Long 테이블_아이디) throws Exception {
        ...
        mockMvc.perform(put("/api/tables/{orderTableId}/empty", 테이블_아이디)
    ...
    private void 주문_테이블_손님_수_설정(Long 테이블_아이디) throws Exception {
        ...
        mockMvc.perform(put("/api/tables/{orderTableId}/number-of-guests", 테이블_아이디)
                        .content(손님_수_변경_요청)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    private void 주문_상태_변경(Long 주문_아이디, OrderStatus 주문_상태) throws Exception {
        ...
        mockMvc.perform(put("/api/orders/{orderId}/order-status", 주문_아이디)
                        .content(주문_상태_변경_요청)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    private void 테이블_그룹_해제(Long 테이블_그룹_아이디) throws Exception {
        mockMvc.perform(delete("/api/table-groups/{tableGroupId}", 테이블_그룹_아이디))
