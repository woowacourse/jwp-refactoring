...
import static kitchenpos.exception.ExceptionInformation.ORDER_IN_EMPTY_TABLE;
import static kitchenpos.exception.ExceptionInformation.UPDATE_COMPLETED_ORDER;
...
public class Order {
    ...
    private static void validateOrderTableIsNotEmpty(final OrderTable orderTable) {
        if (orderTable.isEmpty()) {
            throw new KitchenposException(ORDER_IN_EMPTY_TABLE);
        }
    }
    ...
    public void updateOrderStatus(final OrderStatus updateOrderStatus) {
        if (Objects.equals(OrderStatus.COMPLETION, orderStatus)) {
            throw new KitchenposException(UPDATE_COMPLETED_ORDER);
        }
