...
public class Menu {
    ...
    Menu(Long id, String name, Money price, Long menuGroupId, MenuProducts menuProducts) {
        this.id = id;
        this.name = name;
        this.price = price;
    ...
    Menu(String name, Money price, Long menuGroupId, MenuProducts menuProducts) {
