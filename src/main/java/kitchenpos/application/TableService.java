...
public class TableService {
    ...
    @Transactional
    public OrderTable create(final CreateTableRequest request) {
        OrderTable table = request.toDomain();
    ...
    @Transactional
    public OrderTable changeEmpty(final ChangeTableEmptyRequest request) {
