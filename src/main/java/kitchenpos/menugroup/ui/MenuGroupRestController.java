...
import kitchenpos.menugroup.application.requeest.MenuGroupCreateRequest;
...
public class MenuGroupRestController {
    ...
    public ResponseEntity<MenuGroupResponse> create(@RequestBody MenuGroupCreateRequest menuGroup) {
