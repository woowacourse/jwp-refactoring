...
public class JdbcTemplateTableGroupDao implements TableGroupDao {
    ...
    private static final RowMapper<TableGroup> TABLE_GROUP_MAPPER = (rs, rowNum) ->
            new TableGroup(
                    rs.getLong("id"),
    ...
    public List<TableGroup> findAll() {
        ...
        return jdbcTemplate.query(sql, TABLE_GROUP_MAPPER);
    }
    ...
    private TableGroup select(final Long id) {
        ...
        final SqlParameterSource parameters = new MapSqlParameterSource()
                .addValue("id", id);
        return jdbcTemplate.queryForObject(sql, parameters, TABLE_GROUP_MAPPER);
    }
}
