...
public class TableRestController {
    ...
    public ResponseEntity<OrderTable> changeEmpty(
            ...
            @RequestBody final OrderTableModifyRequest orderTableModifyRequest
    ) {
        return ResponseEntity.ok()
                .body(tableService.changeEmpty(orderTableId, orderTableModifyRequest))
                ;
    }
    ...
    public ResponseEntity<OrderTable> changeNumberOfGuests(
        ...
        return ResponseEntity.ok()
                .body(tableService.changeNumberOfGuests(orderTableId, orderTableModifyRequest));
    }
}
