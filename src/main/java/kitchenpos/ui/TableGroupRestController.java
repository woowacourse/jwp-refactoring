...
public class TableGroupRestController {
    ...
    public ResponseEntity<TableGroupResponse> create(@RequestBody TableGroupCreateRequest tableGroup) {
        TableGroupResponse created = tableGroupService.create(tableGroup);
