...
public class TableGroupRestController {
    ...
    @PostMapping
    public ResponseEntity<TableGroupResult> create(@RequestBody final TableGroupingRequest request) {
        final TableGroupResult created = tableGroupService.create(request);
