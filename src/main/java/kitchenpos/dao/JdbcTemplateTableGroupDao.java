...
public class JdbcTemplateTableGroupDao implements TableGroupDao {
    ...
    @Override
    public TableGroupDto save(final TableGroupDto entity) {
    ...
    @Override
    public Optional<TableGroupDto> findById(final Long id) {
        try {
    ...
    @Override
    public List<TableGroupDto> findAll() {
        final String sql = "SELECT id, created_date FROM table_group";
        return jdbcTemplate.query(sql, (resultSet, rowNumber) -> toEntity(resultSet));
    }

    private TableGroupDto select(final Long id) {
    ...
    private TableGroupDto toEntity(final ResultSet resultSet) throws SQLException {
        final TableGroupDto entity = new TableGroupDto();
