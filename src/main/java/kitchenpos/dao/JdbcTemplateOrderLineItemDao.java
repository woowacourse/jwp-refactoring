...
public class JdbcTemplateOrderLineItemDao implements OrderLineItemDao {
    ...
    public OrderLineItem save(final OrderLineItem entity) {
        String sql = "INSERT INTO order_line_item (quantity, menu_id, order_id) VALUES (:quantity, :menuId, :orderId)";
    ...
    public List<OrderLineItem> findAll() {
        ...
        return jdbcTemplate.query(sql, ORDER_LINE_ITEM_ROW_MAPPER);
    }
    ...
    public List<OrderLineItem> findAllByOrderId(final Long orderId) {
        ...
        return jdbcTemplate.query(sql, parameters, ORDER_LINE_ITEM_ROW_MAPPER);
    }
    ...
    private OrderLineItem select(final Long id) {
        ...
        final SqlParameterSource parameters = new MapSqlParameterSource()
                .addValue("seq", id);
        return jdbcTemplate.queryForObject(sql, parameters, ORDER_LINE_ITEM_ROW_MAPPER);
    }
}
