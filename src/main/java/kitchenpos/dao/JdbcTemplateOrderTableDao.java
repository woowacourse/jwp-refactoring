...
public class JdbcTemplateOrderTableDao implements OrderTableDao {
    ...
    @Override
    public OrderTableDto save(final OrderTableDto entity) {
    ...
    @Override
    public Optional<OrderTableDto> findById(final Long id) {
        try {
    ...
    @Override
    public List<OrderTableDto> findAllByIdIn(final List<Long> ids) {
    ...
    @Override
    public List<OrderTableDto> findAllByTableGroupId(final Long tableGroupId) {
    ...
    private OrderTableDto select(final Long id) {
    ...
    private void update(final OrderTableDto entity) {
    ...
    private OrderTableDto toEntity(final ResultSet resultSet) throws SQLException {
        final OrderTableDto entity = new OrderTableDto();
