...
public class OrderTableValidator {
    ...
    public void validateChangeEmpty(final OrderTable orderTable) {
        validateEmptyIsNotChangeable(orderTable);
    }

    private void validateEmptyIsNotChangeable(final OrderTable orderTable) {
        final Optional<Order> maybeOrder = orderRepository.findByOrderTableId(orderTable.getId());
