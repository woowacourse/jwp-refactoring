...
class OrderTableTest {
    ...
    private final OrderTableValidator orderTableValidator = mock(OrderTableValidator.class);
    ...
    class 비어있음_상태_변경_시 {
        ...
        void 그룹에_속한_테이블의_경우_예외() {
            ...
            willThrow(new OrderTableException("그룹에 속한 테이블은 비어있음 상태를 변경할 수 없습니다."))
                    .given(orderTableValidator).validateChangeEmpty(orderTable);
        ...
        void 조리_혹은_식사중_상태의_테이블이라면_예외() {
            ...
            willThrow(new OrderTableException("조리 혹은 식사중 상태의 테이블의 비어있음 상태는 변경할 수 없습니다."))
                    .given(orderTableValidator).validateChangeEmpty(orderTable);
    ...
    class 언그룹_시 {
        ...
        void 조리_혹은_식사중_상태의_테이블이라면_예외() {
            // given
            OrderTable orderTable = new OrderTable(10, false);
            willThrow(new OrderTableException("조리 혹은 식사중 상태의 테이블이 포함되어 있어 그룹을 해제할 수 없습니다."))
                    .given(orderTableValidator).validateUngroup(orderTable, "조리 혹은 식사중 상태의 테이블이 포함되어 있어 그룹을 해제할 수 없습니다.");
