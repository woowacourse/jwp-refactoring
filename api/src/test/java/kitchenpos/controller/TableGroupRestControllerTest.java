...
import kitchenpos.dto.response.TableInGroupResponse;
...
class TableGroupRestControllerTest extends ControllerTest {
    ...
    void create() throws Exception {
        ...
        CreateTableGroupRequest group = new CreateTableGroupRequest(
                Arrays.asList(new TableIdRequest(1L), new TableIdRequest(2L))
        );
        ...
        TableGroupResponse expected = new TableGroupResponse(
                ...
                LocalDateTime.now(),
                Arrays.asList(
                        new TableInGroupResponse(1L, 0, true),
                        new TableInGroupResponse(2L, 0, true)
                )
        );
