...
class OrderRestControllerTest extends ControllerTest {
    ...
    void create() throws Exception {
        ...
        CreateOrderResponse expected = new CreateOrderResponse(
                ...
                OrderStatus.COOKING,
                LocalDateTime.now(),
                Collections.singletonList(new OrderLineItemResponse(1L, 1L, 2))
        );
    ...
    void list() throws Exception {
        ...
        List<OrderResponse> expected = Arrays.asList(
                new OrderResponse(1L, OrderStatus.COOKING, LocalDateTime.now(), new ArrayList<>()),
                new OrderResponse(1L, OrderStatus.COMPLETION, LocalDateTime.now(), new ArrayList<>())
        );
    ...
    void changeOrderStatus() throws Exception {
        ...
        OrderResponse expected = new OrderResponse(
                ...
                Collections.singletonList(
                        new OrderLineItemResponse(1L, 1L, 2L)
                )
        );
