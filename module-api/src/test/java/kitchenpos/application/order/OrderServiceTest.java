...
class OrderServiceTest {
    ...
    class OrderChangeStatus {
        ...
        void changeOrderStatus_InvalidOrderId_ExceptionThrown() {
            ...
            // when
            // then
            Assertions.assertThatThrownBy(() -> orderService.changeOrderStatus(INVALID_ID, orderStatusRequestDto))
                .isInstanceOf(InvalidOrderException.class)
                .hasFieldOrPropertyWithValue("httpStatus", HttpStatus.BAD_REQUEST);
        }
        ...
        void changeOrderStatus_CompletionOrderStatus_ExceptionThrown() {
            ...
            // when
            // then
            Assertions.assertThatThrownBy(() -> orderService.changeOrderStatus(order.getId(), orderStatusRequestDto))
    ...
    void list_Success() {
        ...
        // then
        Assertions.assertThat(result).hasSize(previousSize + 1);
    }
