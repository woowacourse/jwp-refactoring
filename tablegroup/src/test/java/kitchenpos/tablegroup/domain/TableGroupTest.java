...
class TableGroupTest {
    ...
    class 단체_지정을_할_때 {
        ...
        void 주문_테이블_ID_목록과_저장된_주문_테이블_목록의_사이즈가_다를_경우_예외를_던진다() {
            ...
            // expect
            Assertions.assertThatThrownBy(() -> tableGroup.group(savedOrderTables, groupTableIds))
        ...
        void 주문_테이블_목록이_비었으면_예외를_던진다() {
            ...
            // expect
            Assertions.assertThatThrownBy(() -> tableGroup.group(invalidOrderTables, groupTableIds))
                    .isInstanceOf(IllegalArgumentException.class)
    ...
    class 단체_지정을_해제할_때 {
        ...
        void 조리_혹은_식사_주문이_존재하는_경우_예외를_던진다() {
            ...
            // expect
            Assertions.assertThatThrownBy(() -> tableGroup.ungroup(groupTables, tableOrders))
                    .isInstanceOf(IllegalArgumentException.class)
        ...
        void 정상적으로_해제한다() {
            ...
            // expect
            Assertions.assertThatNoException().isThrownBy(() -> tableGroup.ungroup(groupTables, tableOrders));
        }
    }
}
