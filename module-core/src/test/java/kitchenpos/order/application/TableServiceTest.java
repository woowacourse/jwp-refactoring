...
class TableServiceTest {
    ...
    class ChangeEmptyTest {
        ...
        void changeEmptyWithNonExistOrderTable() {
            ...
            Assertions.assertThatThrownBy(() -> tableService.changeEmpty(nonExistOrderTableId, request))
        ...
        void changeEmptyWithAssignedTableGroup() {
            ...
            Assertions.assertThatThrownBy(() -> tableService.changeEmpty(orderTableId, request))
                    .isInstanceOf(IllegalArgumentException.class)
    ...
    class ChangeNumberOfGuestsTest {
        ...
        void changeNumberOfGuestsWithNegative() {
            ...
            Assertions.assertThatThrownBy(() -> tableService.changeNumberOfGuests(orderTableId, request))
                    .isInstanceOf(IllegalArgumentException.class)
        ...
        void changeNumberOfGuestsWithNonExistOrderTable() {
            ...
            Assertions.assertThatThrownBy(() -> tableService.changeNumberOfGuests(nonExistOrderTableId, request))
                    .isInstanceOf(IllegalArgumentException.class)
                    .hasMessage("주문 테이블을 찾을 수 없습니다.");
        }
    ...
    private OrderTable saveEmptyOrderTable() {
        return orderTableRepository.save(Fixture.makeEmptyOrderTable());
    }

    private OrderTable saveNonEmptyOrderTable(final int numberOfGuests) {
        return orderTableRepository.save(Fixture.makeNonEmptyOrderTable(numberOfGuests));
    }
